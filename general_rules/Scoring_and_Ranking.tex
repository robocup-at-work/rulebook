...
\begin{description}
  ...
  \item[Red/White Tape]: This tape represents a virtual wall with an infinitely height. This wall shall not be crossed. If any part of the robot (including the manipulator, excluding cables) is above the tape, it is considered a major collision. This tape is typically used to limit the area of the arena.
