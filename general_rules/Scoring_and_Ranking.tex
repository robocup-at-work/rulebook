...
\textcolor{red}{If a major collision occurs the first time, the team can decide between the following two options:
\begin{itemize}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width= 1\textwidth,  ]{./images/tabels/robocup_penalty_points.png}
	\caption{Scoring in the instances of the \RCAW \YEAR competition.}
