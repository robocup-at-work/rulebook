...
\begin{table}[h!]
  ...
  \begin{tabular}{|l|p{1.5cm}|p{1.5cm}|}
    ...
    Robot Body Collision with workstation &  & \\
    Robot Manipulator Collision with manipulation zone &  & \\
    Robot Manipulator Collision with Round Table stopping it &  & \\
    Robot Manipulator Collision with PPT Cavity surface &  & \\
    Robot Manipulator Collision with Shelf &  & \\
		Barrier tape collisions?  &  & \\
    \hline
	\end{tabular}
\end{table}
