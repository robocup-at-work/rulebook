...
For the precise placement tests, a special PP tile is used which allows a tag to be placed with a constant offset from the hole (see fig. \ref{fig:cubeObjectTile}). The used ID matches the ID of the object that must be placed into that cavity.
