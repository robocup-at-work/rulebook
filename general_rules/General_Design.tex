...
The basic set of Objects (called @work Object Set) includes standard profile rails, screws and nuts with various sizes and masses (see table~\ref{tab:manipulation_objects}).
