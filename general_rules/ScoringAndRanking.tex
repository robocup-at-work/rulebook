...
\section{Scoring} \label{ssec:ScoringAndRanking}
 ...
 \begin{tabular}{|l|l|l|l*{12}{|P{1cm}}|}
   ...
   \hhline{~~~~--------} \hline
    \multirow{17}{0.5cm}{\R{\centering Manipulation }{3cm}}
     ...
     & \C\RCAW \&  RoCKIn    & Team    &       &\C 2   &       &       &       &       &       &    \\ \hhline{~~~---------}
     &    &                 & RefBox   &       &\C 3   & \C 5     &  \C 6   &  \C6   &  \C 3    &  \C3     & \C 10 \\ \hhline{~~----------}
     ...
     & \multirow{7}{0.5cm}{\R{\centering Grasping }{2cm}}
      ...
      &  & Red container       & RefBox &       &       &       &       &  \C 2   &       &   & \C 2   \\ \hhline{~~----------}
      &  & Blue container      & RefBox &       &       &       &       &  \C 2   &       &   & \C 2   \\ \hhline{~~----------}
 ...
 \begin{tabular}{|p{5.5cm}*{9}{|P{1cm}}|}
   ...
   \hline
    Correct destination reached     &  50  &      &       &       &       &       &       &      \\
		  \hspace{0.5cm} \C{correct service area reached}&     &   \C{25}   &  \C{25}     &   \C{25}    &  \C{25}     &       &       &   \C{25}   \\ \hline
    Correct object grasping standard&      & \C\sout{100} \newline 75  &  \C\sout{100} \newline 75   & \C\sout{100} \newline 75    &  \C\sout{100} \newline 75   &       &       &  \C\sout{100} \newline 75  \\
		\hspace{0.5cm} round table        &      &      &       &       &       &       &   \C{200}       &   \C{200}   \\ \hline
    Correct object placing standard &      & 100  &  100  & 100   &  100  &       &       &  100  \\
		\hspace{0.5cm} PPT area           &      &      &       &       &       &  250   &       &   250  \\
		\hspace{0.5cm} shelf upper level  &      &      &       &       & 150&       &       &   150  \\
		\hspace{0.5cm} shelf lower level  &      &      &       &       & \C 300&       &       &   \C 300  \\ \hline
