...
\subsection{Scoring}
Points are awarded according to Table \ref{tab:InstancePoints}.
...
\begin{table}[h!]
 ...
 \begin{tabular}{|p{5cm}*{8}{|P{1cm}}|}
   \hhline{~--------}
   \multicolumn{1}{l|}{ } &  \multicolumn{7}{c|}{ Instances}\\
   \hhline{~--------}
   ...
   \hline
    ...
    \robin{Maximum} Barrier Tape penalty    &       &  200  &       &  300  &       &       &  400  \\ \hline\hline
...
\begin{table}[h!]
 ...
 \begin{tabular}{|l|l|l|l*{9}{|P{1cm}}|}
   ...
   \hhline{~~~~---------}
   \multicolumn{4}{l|}{ }          &\cir{1}&\cir{2}&\cir{3}&\cir{4}&\cir{5}&\cir{6}&\cir{7}\\
   \multicolumn{4}{r|}{     }        & BMT   & BTT1  & BTT2  &  BTT3 &  PPT  &  RTT & Final\\
   \hhline{~~~~---------} \hline
