...
If the projection of any part of a robot touches a barrier tape marking a virtual wall it counts as a collision. \textcolor{red}{The maximum penalty resulting from these collisions depends on the specific competition instance and is listed in Tab.~\ref{tab:InstancePoints}.}
...
\begin{itemize}
	...
	\item \textcolor{red}{Scores that are received after a restart are multiplied by a factor of 0.75}
