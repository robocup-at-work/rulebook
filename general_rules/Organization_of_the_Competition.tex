...
\par
An object is considered as being grasped, when it is moved out of the manipulation area (e.g. over the robot). Points or penalties are scored according to the test specification.
\par
