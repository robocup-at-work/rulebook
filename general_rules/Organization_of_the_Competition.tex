...
\end{itemize}
A team of referees supervise all runs of one test. If the referees disagree the TC will decide. \todo{The appointment of the referees has to be announced to the teams in combination to the test schedule. OK?}
