...
\todo{This step should help us to have a compact run that is interesting
for visitors but provides a reliable schedule too. In Leipzig many teams had
have to perform before the mentioned schedule due to the fact, that other
teams did suddenly not participated.}
