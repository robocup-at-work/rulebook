...
\revdel{6.1.2 Scenario Environment}
...
\item \revdel{A team has a time period of 5 minutes to complete the task, in addition to the default preparation time.} \note{remove, since the time will be specified on the instance page. (Fred)}
...
\item The time is stopped when the robot has completed the task and left the arena. If the team cannot complete the task within \revcha{5 minutes}{the designated time}, the run will be stopped\revdel{ after 5 minutes}.
\end{itemize}
%
%
%
