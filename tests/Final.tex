...
The \iaterm{Final Run}{Final} acts as the full benchmark for robots, including all previous test types in a single run. Basically it is a BTT with both PPT and RTT included.
