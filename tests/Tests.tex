...
%    &      \RCAW           & Team     &       &       &       &       &       &       &       &    &    \\ \hhline{~~~----------}
     &      \RCAW           & RefBox   &       &   3   &  5    &   \cellcolor{red!50}3 &   4   &    3   & 3  & 5  \\ \hhline{~~----------}
     &    & RoCKIn          & Team     &       &   2   &       &       &       &       &       &    \\ \hhline{~~~---------}
     &    &                 & RefBox   &       &       &       &   3   &   3   &       &       & 5  \\ \hhline{~~----------}
     &    & Decoy           & RefBox   &       &       &  3    &       &   3   &       &       & 5   \\ \hhline{~~----------}
     &    & Table height           & RefBox   &       & 10 cm & 10 cm & \cellcolor{red!50} 5cm \newline 10 cm &  0 cm\newline 10 cm\newline 15 cm    &  10 cm &  \cellcolor{red!50} 10 cm & 0 cm\newline 5 cm\newline 10 cm\newline 15 cm \\
    %&    & Number          & TC/OC    &       &   5   &  5    &   5   &   7   &   3   &   3   & 3  & 10  \\ 
     \hhline{~-----------} \hhline{~-----------}
     & \multirow{7}{0.5cm}{\R{\centering Grasping }{2cm}}
%       & Height           & RefBox   &       & 10 cm & 10 cm & \cellcolor{red!50} 5cm \newline 10 cm &  0 cm\newline 10 cm\newline 15 cm    &  10 cm & & & 0 cm\newline 5 cm\newline 10 cm\newline 15 cm \\ \hhline{~~-----------}
...
%    &   & Dynamic obstacles  & -       &       &       &       &       &       &       &       &   &    \\ \hhline{~~-----------}
     &   & Barrier tape       & Referee &  2    &       &   1   &       & \cellcolor{red!50}  1    &       &   & 2   \\ \hhline{~~----------}
     &   & Waypoints          & RefBox  &  9    &       &       &       &       &       &   &    \\ 
		\hline \hline
		 \multicolumn{3}{|l|}{Duration} 
		                    & RefBox & 5 min   & 5 min & 5 min  & \cellcolor{red!50} 8 min & \cellcolor{red!50} 8 min & 5 min & 5 min & 10min \\
		\hline
 \end{tabular}
