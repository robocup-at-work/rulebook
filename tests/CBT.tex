...
\todo{[Sebastian] I would propose to shrink this test on the rotating table
only. The conveyor belt provides the capability of just one catching operation
while the rotating table implements more than one trial and is much more attractive
for visitors.}
...
\begin{figure} [h!]
	\begin{center}
		...
		\hspace{1cm}
		\subfloat[Rotating table]{\includegraphics[height = 4cm]{./images/rotating_table.jpg}} 
	\end{center}
