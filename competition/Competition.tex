...
The job of each ref is to ensure that the arena state before each performance is the same as the initial run setup.
...
the competition may be seperated into different stages.
Starting with the rather easy tests including all teams, 
only high performing teams might be allowed to participate in later (more difficult) tests.
