...
%	\item  Do we really keep the old task spec representation? Or do we use something more elegant like XML? (Fred)
...
%\section{Object Perception Challenge}
%\section{Assembly Challenge}
