...
\newcommand{\robin}[1]{\todo[color=blue!40, inline]{[Robin     ] #1}}
\newcommand{\jeanne}[1]{\todo[color=blue!40, inline]{[Jeanne     ] #1}}
...
\szug{This is an example of our personal todonote style}
\robin{Additional one ...}
